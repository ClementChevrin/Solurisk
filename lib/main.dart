...
import 'page/menu/menu_page.dart';
...
void main() {
  runApp(MaterialApp(theme: ThemeApp.currentTheme, debugShowCheckedModeBanner: false, title: StringValue.nameApp.elementAt(StringValue.currentLanguage), home: const MainApp()));
}
...
onCreate(BuildContext context) async {
  ...
  List<ItemFormulaire> listItemFormulaire = [
    ItemFormulaire(
...
class MainPage extends State<MainApp> {
  @override
  void initState() {
    super.initState();
      ...
      body: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(StringValue.nameApp.elementAt(StringValue.currentLanguage), style: GoogleFonts.nunito(fontWeight: FontWeight.w700, fontSize: 20, color: Theme.of(context).themeExtension().colorPrimary)),
          ],
        ),
      ),
    );
